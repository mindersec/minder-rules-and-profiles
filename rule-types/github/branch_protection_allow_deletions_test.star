def test_force_push_not_allowed():
    res = eval(
        ...
        profile={},
        mock_http={
            "/repos/mindersec/minder/branches/main/protection": body("{\"allow_deletions\": {\"enabled\": false}}")
        }
    )
...
def test_force_push_allowed():
    res = eval(
        ...
        profile={},
        mock_http={
            "/repos/mindersec/minder/branches/main/protection": body("{\"allow_deletions\": {\"enabled\": true}}")
        }
    )
